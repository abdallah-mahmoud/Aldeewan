...
void _transactionModelSerialize(
  ...
  writer.writeString(offsets[5], object.personId);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.personId = reader.readStringOrNull(offsets[5]);
  object.type =
      _TransactionModeltypeValueEnumMap[reader.readStringOrNull(offsets[6])] ??
  ...
  switch (propertyId) {
    ...
    case 6:
      return (_TransactionModeltypeValueEnumMap[
          ...
          TransactionType.saleOnCredit) as P;
    case 7:
...
const _TransactionModeltypeEnumValueMap = {
  r'saleOnCredit': r'saleOnCredit',
  r'paymentReceived': r'paymentReceived',
  r'purchaseOnCredit': r'purchaseOnCredit',
  r'paymentMade': r'paymentMade',
  r'cashSale': r'cashSale',
  r'cashIncome': r'cashIncome',
  r'cashExpense': r'cashExpense',
};
const _TransactionModeltypeValueEnumMap = {
  r'saleOnCredit': TransactionType.saleOnCredit,
  r'paymentReceived': TransactionType.paymentReceived,
  r'purchaseOnCredit': TransactionType.purchaseOnCredit,
  r'paymentMade': TransactionType.paymentMade,
  r'cashSale': TransactionType.cashSale,
  r'cashIncome': TransactionType.cashIncome,
  r'cashExpense': TransactionType.cashExpense,
};
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, String?, QQueryOperations> personIdProperty() {
    return QueryBuilder.apply(this, (query) {
